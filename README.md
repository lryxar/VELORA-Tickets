...
- `support-panel.json` controls the support ticket panel, category, role, welcome message, and close message.
- `purchase-panel.json` controls the purchase ticket panel independently.
...
This bot intentionally uses only `discord.js` and `dotenv` to remain lightweight and easy to run on low-resource systems.
